...
namespace Shadowsocks.View
{
	public class MenuViewController
	{
		...
		{
			controller.UpdatePACFromOnlinePac(@"https://raw.githubusercontent.com/zhiopi/Update-files/master/ss_lanip.pac");
		}

		private void UpdatePACFromCNWhiteListItem_Click(object sender, EventArgs e)
		{
			//controller.UpdatePACFromOnlinePac(@"https://raw.githubusercontent.com/zhiopi/Update-files/master/ss_white.pac");
		...
		{
			//controller.UpdatePACFromOnlinePac(@"https://raw.githubusercontent.com/zhiopi/Update-files/master/ss_white_r.pac");
		...
		{
			//controller.UpdatePACFromOnlinePac(@"https://raw.githubusercontent.com/zhiopi/Update-files/master/ss_cnip.pac");
